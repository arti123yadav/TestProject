	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			...
			<form action="LoginServlet" class="navbar-search pull-left" method="post">
			...
			<li class="dropdown">
				...
				<form class="form-horizontal loginFrm" action="LoginServlet" method="post">
...
<div class="well well-small">
	...
	<form class="form-horizontal" action="RegisterServlet" method="post">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="inputFname" placeholder="First Name" name="inputFname">
			</div>
		 </div>
		 <div class="control-group">
			<label class="control-label" for="inputLname">Last name <sup>*</sup></label>
			<div class="controls">
			  <input type="text" id="inputLname" placeholder="Last Name" name="inputLname">
			</div>
		 </div>
		<div class="control-group">
