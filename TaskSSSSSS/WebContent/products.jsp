	...
	<ul class="nav nav-list">
		...
		<li> <a class="totalInCart" href="cart.html"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;">$448.42</span></strong></a></li>
			  ...
			  <div class="well well-small alert alert-warning cntr">
				...
				out.print(sessions.getAttribute("abc"));
				
				
				%>
				  <p> 
					<br><br><a class="defaultBtn" href="#">Click here </a>
				  </p>
			  </div>
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p>Manicure & Pedicure</p>
					<p><strong> $22.00</strong></p>
					<h4><a class="shopBtn" href="AddServlet" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						<a class="pull-left" href="#">Add to Wish List </a> 
						<a class="pull-left" href="#"> Add to Compare </a>
					</div> 
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p>Manicure & Pedicure</p>
					<p><strong> $22.00</strong></p>
					<h4><a class="shopBtn" href="product_details.html" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						<a class="pull-left" href="#">Add to Wish List </a> 
						<a class="pull-left" href="#"> Add to Compare </a>
					</div> 
...
<div class="container">
	<p class="pull-right">
		<a href="#">hiiiiipayment<img src="assets/img/maestro.png" alt="payment"></a>
