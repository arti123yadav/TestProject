	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			...
			<form action="add.jsp" class="navbar-search pull-left">
...
<div class="well well-small">
	...
	<div class="row-fluid">
			...
			<div class="span7">
				...
				<form class="form-horizontal qtyFrm" action="AddServlet">
				  <div class="control-group">
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <select class="span11" name="color" id="color">
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <select class="span11" name="material" id="material">
				  ...
				  <p>
				  <button type="submit" name="submit" class="shopBtn"><span class=" icon-shopping-cart"></span> Add to cart</button>
				</form>
			</div>
			</div>
				<hr class="softn clr"/>
