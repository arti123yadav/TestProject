	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a href="ProfileServlet"><span class="icon-user"></span> My Account</a> 
	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			...
			<li class="dropdown">
				<a data-toggle="dropdown" class="dropdown-toggle" href="LoginServlet"><span class="icon-lock"></span> Login <b class="caret"></b></a>
